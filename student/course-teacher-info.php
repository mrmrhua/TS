<?php
	...
	$sql = "select teacher_name,department,title,tel,email,intro,paper_intro from teacher where tid=".$_GET['tid'].";";
	$teacher_result =$db->query($sql);
	...
	<div class="page-container"><!-- add class "sidebar-collapsed" to close sidebar by default, "chat-visible" to make chat appear always -->
		...
		<div class="main-content">
			...
			<div class="page-title">
				...
				<div class="title-env">
					<h1 class="title">教师介绍</h1>
					<p class="description">显示教师的介绍信息</p>
				</div>
					...
					<div class="panel panel-default">
						...
						<div class="panel-body">
							...
							<div class="form-group">
								...
								<div class="col-sm-5">
									<?php echo $teacher_row['teacher_name']; ?>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-5">
									<?php echo $teacher_row['department']; ?>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-5">
									<p><?php echo $teacher_row['intro']; ?></p>
							...
							<div class="form-group">
								...
								<div class="col-sm-5">
									<p>b<?php echo $teacher_row['paper_intro']; ?></p>
								</div>
							</div>
