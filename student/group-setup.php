<?php
	session_start();
		if(isset($_POST['submit'])){
			...
			$sql="select group_id from groups where group_name='".$_POST['group_name']."';";
			$result = $db->query($sql);
			if($result->num_rows == 0){
				...
				$sql = "INSERT INTO  `groups` (  `group_name` ,  `class_id` ,  `leader_account` ,  `enter_passwd`, `cid`  )VALUES ('".$_POST['group_name']."',".$row['class_id'].",'".$_SESSION['USERNAME']."','".$_POST['group_password']."',".$_GET['cid'].");";
				$db->query($sql);
				header("Location:"."/student/group-info.php?cid=".$_GET['cid']);
			}
			else{
				$dup = 1 ;    //重复了
				header("Location:"."/student/group-setup.php?cid=".$_GET['cid']);
			}
